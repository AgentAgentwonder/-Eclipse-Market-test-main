...
export function ChangelogViewer() {
  // Use individual atomic selectors instead of object selector
  const isViewerOpen = useChangelogStore(state => state.isViewerOpen);
  const filter = useChangelogStore(state => state.filter);
  const closeViewer = useChangelogStore(state => state.closeViewer);
  const setFilter = useChangelogStore(state => state.setFilter);
  const clearFilters = useChangelogStore(state => state.clearFilters);
  const getFilteredReleases = useChangelogStore(state => state.getFilteredReleases);
  const getAllTags = useChangelogStore(state => state.getAllTags);
