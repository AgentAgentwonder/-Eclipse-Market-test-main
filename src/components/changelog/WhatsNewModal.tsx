...
export function WhatsNewModal({ currentVersion }: WhatsNewModalProps) {
  ...
  const openViewer = useChangelogStore(state => state.openViewer);
  const closeWhatsNew = useChangelogStore(state => state.closeWhatsNew);
  const getUnseenReleases = useChangelogStore(state => state.getUnseenReleases);
