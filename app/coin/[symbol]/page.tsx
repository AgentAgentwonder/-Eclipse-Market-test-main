...
export default function CoinDetailPage() {
  ...
  const handleQuickBuy = (amount: number) => {
    console.log("[v0] Quick buy:", amount, "of", symbol)
    // Integrate with your trading logic here
  }

  const handleQuickSell = () => {
    console.log("[v0] Quick sell all of", symbol)
    // Integrate with your trading logic here
  }
  ...
  const handleCustomBuy = () => {
    ...
    if (!isNaN(amount) && amount > 0) {
      console.log("[v0] Custom buy:", amount, "of", symbol)
      // Integrate with your trading logic here
      setBuyAmount("")
    }
  }
  ...
  return (
    <div className="p-4 h-screen overflow-hidden flex flex-col space-y-4 fade-in">
      ...
      <div className="flex items-center gap-4">
        <button onClick={() => router.back()} className="p-2 hover:bg-muted rounded transition-colors">
